...
SET SC_M = 'SC_M_' || $TARGET_SCHEMA_NAME; -- Monitor role
SET SC_R = 'SC_R_' || $TARGET_SCHEMA_NAME; -- Reader role
SET SC_W = 'SC_W_' || $TARGET_SCHEMA_NAME; -- Writer role
SET SC_C = 'SC_C_' || $TARGET_SCHEMA_NAME; -- Creator role
